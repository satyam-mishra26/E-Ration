...
def send_otp(number, message):
    ...
    api = "1554K6H0oKk6XMc9wHDvfZpbXNgEF79BK3GAjWuS6HR8uniKRqw0TKuQQUuT"
...
def Registration(request):
    if request.method == "POST":
        ...
        if fm.is_valid() and up.is_valid():
            ...
            subject = 'welcome to E Ration Shop'
            message = f'Hi {user.username}, thank you for registering in E Ration Shop.'
...
def userLogin(request):
    ...
    if request.method == "POST":
        ...
        if user is not None:
            ...
            message = f'E Ration Shop Website otp is {otp}'
            send_otp(p_number, message)
